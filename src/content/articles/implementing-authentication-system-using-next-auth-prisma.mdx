---
title: Implement role-base authentication system using Next.js with app dir
description: A guide that explains how to build a role-base authentication system using Next-Auth and Prisma Adapter.
date: 2023-09-19
timeToRead: "12"
---

In this article post, I'll walk you through the step-by-step process of creating role-based authentication system for your Next.js application using Next Auth and Prisma adapter credentials. You’ll have a solid foundation to build flexible and scalable user access control systems by the end.
